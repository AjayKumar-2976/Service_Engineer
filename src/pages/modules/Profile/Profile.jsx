...
//     default:
//       return "bg-white text-[#7EC1B1] px-3 py-1 rounded-full";
//   }
// };

//   return (
//     <div className="bg-white shadow-md rounded-lg p-6 sm:p-10 mt-6 w-full mx-auto relative">
//       <Header2/>
...
//   className={`border border-[#7EC1B1] outline-none cursor-pointer text-sm ${getStatusStyle()}`}
// >
//   <option value="Available" className="text-black bg-white">
//     Available
//   </option>
//   <option value="Busy" className="text-black bg-white">
//     Busy
//   </option>
...
//           className="border border-[#7EC1B1] text-[#7EC1B1] px-6 py-2 rounded-md hover:bg-[#7EC1B1] hover:text-white transition"
//         >
//           Edit Profile
//         </button>
//       </div>
...
//           </div>
//           <p className="text-[#7EC1B1] mb-3">{profileData.area}</p>
...
//         <div>
//           <div className="mb-6">
//             <p className="text-gray-700 font-semibold mb-1">Skill</p>
//             <p className="text-[#7EC1B1]">{profileData.skill}</p>
//           </div>

//           <div className="mb-6">
//             <div className="flex items-center gap-2 mb-1">
//               <FiPhone className="text-[#7EC1B1]" />
//               <p className="text-gray-700 font-semibold">Phone Number</p>
//             </div>
//             <p className="text-[#7EC1B1]">{profileData.phone}</p>
//           </div>

//           <div>
//             <div className="flex items-center gap-2 mb-1">
//               <FiLock className="text-[#7EC1B1]" />
//               <p className="text-gray-700 font-semibold">Password</p>
//             </div>
//             <p className="text-[#7EC1B1]">{profileData.password}</p>
//           </div>
//         </div>
//       </div>
...
//           <div className="bg-white rounded-lg shadow-lg p-8 sm:p-12 w-11/12 sm:w-[40rem] h-auto border border-gray-300">
...
//                 className="w-full bg-[#F5F5F5] border border-gray-300 rounded-md px-4 py-3 text-lg"
//               />
//               <input
//                 type="password"
...
//               className="bg-[#7EC1B1] text-white px-8 py-3 rounded-md hover:bg-[#66b0a0] transition text-lg"
//             >
//               Login Again
//             </button>
//           </div>
